              ...
              <div className="container">
                <div className="section_title text-center">
                  ...
                  <p className="wow fadeInUp" data-wow-delay="0.4s">
                    Znam da matematika ponekad može biti teška i frustrirajuća, ali ne brini – tu sam da ti pomognem da je savladaš s lakoćom!
                  </p>
                </div>
                    ...
                    <div className="saas_features_content wow fadeInLeft" data-wow-delay="0.2s">
                      ...
                      <ul className="list-unstyled saas_list">
                        ...
                        <li>
                          ...
                          Pomoć pri učenju za testove: Pripremit ću te za testove i ispite, tako da se osjećaš samouvjereno i spremno
                        </li>
                        <li>
                          <div className="icon">
                            <img src="/assets/img/home-one/check.png" alt="" />
                    ...
                    <div className="saas_features_content wow fadeInLeft" data-wow-delay="0.2s">
                      ...
                      <ul className="list-unstyled saas_list">
                        ...
                        <li>
                          ...
                          Učimo zajedno: Kroz interaktivnu sesiju, objasnit ću ti sve što ti je potrebno da savladaš gradivo
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <section className="testimonial_area_one sec_padding">
              <div className="container">
                <div className="section_title text-center">
                  ...
                  <p className="wow fadeInUp" data-wow-delay="0.4s">
                    Manual time entry is prone to errors and can negatively impact your company&apos;s reputation with paycheck errors. When it&apos;s manual,
                    it&apos;s prone to error, and the
                  </p>
                </div>
              </div>
              <div className="testimonial_slider_two wow fadeInUp" data-wow-delay="0.2s">
                <div className="item">
                  ...
                  <p>
                    &quot;Sviđa mi se EdureteAI jer mi je više modela na raspolaganju na jednom mjestu. S obzirom da umjetna inteligencija nije uvijek pouzdana,
                    pogotovo u rješavanju matematičkih zadataka, ako jedan model ne uspije riješiti zadatak, najčešće se među ostalima nađe onaj koji zna.&quot;
                  </p>
                ...
                <div className="item">
                  ...
                  <p>
                    &quot;Kroz proteklih godinu dana, primijetila sam kako su AI modeli znatno napredovali u testiranju zadataka, posebno u brzini i točnosti.
                    AI modeli u trenutnom izdanju nude izvrstan, novi princip učenja koji osigurava jasne odgovore na pitanja i objašnjenja gradiva na
                    jednostavan i razumljiv način u svako doba dana i noći. Također, vjerujem da bi bio izuzetno koristan za učenike jer pruža instantne
                    povratne informacije prilagođene potrebama pojedinca.&quot;
                  </p>
                  <div className="client_info">
                ...
                <div className="item">
                  ...
                  <p>
                    &quot;Kao instruktor matematike, najveću prednost naše aplikacije vidim u tome što omogućuje korištenje različitih LLM-ova i modela,
                    pružajući uvid u različite načine rješavanja istog zadatka – nekad detaljno i temeljito, nekad sažeto i brzo, uz primjenu različitih metoda.
                    Time učenici dobivaju širi pregled i dublje razumijevanje matematike. Posebno mi se sviđa što je naš sistemski prompt pažljivo osmišljen
                    kako bi iz svakog modela izvukao ono najbolje, osiguravajući ne samo točne odgovore, već i jasna, korisna objašnjenja koja učenicima zaista
                    pomažu da shvate gradivo.&quot;
                  </p>
                  <div className="client_info">
                ...
                <div className="item">
                  ...
                  <p>
                    &quot;Kod EdureteAI me iznenadila njegova svestranost i prilagodljivost zadacima koji se pred njega stave. Uspješno rješava veliku većinu
                    matematičkih i drugih zadataka. U sebi sadrži više modela koji omogućuju da se istom problemu pristupi s više gledišta ili postupaka što
                    produbljuje razumijevanje problema. Veliku prednost vidim i u opciji da se personalizira pristup i način na koji EdureteAI daje odgovore
                    putem ugrađenog prozora dodatnih postavki. Ako umjetna inteligencija korisniku ipak ne pruži zadovoljavajući rezultat, tu smo uvijek mi,
                    instruktori, da ponudimo rješenje.&quot;
                  </p>
                  <div className="client_info">
                ...
                <div className="item">
                  ...
                  <p>
                    &quot;Prednost EdureteAI-a je u tome što pružamo više opcija za rješavanje zadataka, prilagođenih različitim stilovima učenja. Nalazimo se u
                    vremenu kada priprema za maturu postaje optimalnija nego ikada prije, omogućujući učenicima učinkovitije usvajanje gradiva i bolje
                    rezultate.&quot;
                  </p>
                  <div className="client_info">
                ...
                <div className="item">
                  ...
                  <p>
                    &quot;Najveća prednost aplikacije EdureteAI koju sam primijetila je mogućnost pružanja pomoći u rješavanju i objašnjenju teorije
                    jednostavnijih i kompliciranijih matematičkih zadataka u doba dana kada profesionalni stvarni instruktori inače nisu dostupni. Drugu
                    prednost koja je dosta izražena je mogućnost korištenja više modela pomoću kojih se mogu dobiti različiti postupci rješavanja istog
                    zadatak.&quot;
                  </p>
                  <div className="client_info">
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-4 col-md-6">
                    <div className="saas_price_item">
                      ...
                      <ul className="list-unstyled">
                        <li>
                          <img className="d-inline" src="/assets/img/home-one/check_3.png" alt="" /> 10 tokena
                        </li>
                        <li>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="saas_price_item">
                      ...
                      <ul className="list-unstyled">
                        <li>
                          <img className="d-inline" src="/assets/img/home-one/check_3.png" alt="" /> 500 tokena
                        </li>
                        <li>
                          <img className="d-inline" src="/assets/img/home-one/check_3.png" alt="" /> Odabrani snimci za lakše učenje
                        </li>
                        <li>
                          <img className="d-inline" src="/assets/img/home-one/check_3.png" alt="" />{" "}
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="saas_price_item">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li>
                          <img className="d-inline" src="/assets/img/home-one/check_3.png" alt="" /> 2 X 30 minuta svaki mjesec sa instruktorom
                        </li>
                      </ul>
                      <a href="#" className="price_btn">
                        Isprobaj
              ...
              <div className="container">
                <div className="section_title text-center">
                  ...
                  <p className="wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <br className="d-none d-lg-block" /> purchase, updates, and support.
                  </p>
                </div>
                <div className="row justify-content-center">
