...
const initialUsers = [
  { id: 1, email: "sinisa@dvasadva.com", tokens: 4067, amount: 0.0004, limit: 5 },
  { id: 2, email: "sinisa@dvasadva.hr", tokens: 1335, amount: 0.0001, limit: 5 },
  { id: 3, email: "test@example.com", tokens: 7465, amount: 0.0007, limit: 5 },
...
export default function AppDashboardAnthropicPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 mb-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Anthropic Total Tokens (This Month)</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Anthropic Total Amount (This Month)</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Anthropic API Monthly Usage Data</CardTitle>
        </CardHeader>
        <CardContent>
