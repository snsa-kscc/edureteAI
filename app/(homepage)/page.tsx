      ...
      <div className="body_wrapper">
        <nav className="navbar navbar-expand-lg sticky_nav">
          <div className="container d-flex justify-content-between">
            <a className="navbar-brand" href="/"><img src="/assets/img/logo.svg" alt="logo"/></a>
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav menu me-lg-auto ms-lg-auto">
                <li className="nav-item"><a href="#why-us" className="nav-link">Učimo drugačije</a></li>
                <li className="nav-item"><a href="#reviews" className="nav-link">Recenzije</a></li>
                <li className="nav-item"><a href="#pricing" className="nav-link">Paketi</a></li>
        ...
        <section className="saas_features_area" id="why-us">
          <div className="container">
            <div className="section_title text-center">
              ...
              <p className="wow fadeInUp" data-wow-delay="0.4s">Bilo da je za školu ili maturu, uz nas, matematika više nikad ne čeka</p>
            </div>
            ...
            <div className="row flex-row-reverse saas_features_item three">
              <div className="col-lg-6">
                <div className="saas_features_img saas_banner_img" data-bg-color="#B3F7D5">
                  <img className="img_small" src="/assets/img/home-one/main.png"  style={{display : 'block', margin: '0 auto', position: 'relative', top: 20, left: 0, maxWidth: '100%'}}/>
              ...
              <div className="col-lg-6">
                <div className="saas_features_content wow fadeInLeft" data-wow-delay="0.2s">
                  ...
                  <ul className="list-unstyled saas_list">
                    ...
                    <li>
                      <div className="icon"><img src="/assets/img/home-one/check.png" alt=""/></div>
                      Dodatna pomoć: asistencija i generiranje sličnih zadataka Podrška instruktora: obrada dodatnih pitanja i pojašnjenja
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="testimonial_area_one sec_padding" id="reviews">
          <div className="container">
            <div className="section_title text-center">
              ...
              <p className="wow fadeInUp" data-wow-delay="0.4s">Na temelju povratnih informacija, kontinuirano
                usavršavamo našu ponudu kako bismo zadovoljili potrebe korisnika.</p>
            </div>
          </div>
          <div className="testimonial_slider_two wow fadeInUp" data-wow-delay="0.2s">
            <div className="item">
              ...
              <p>"Sviđa mi se edureteAI jer je više modela na raspolaganju na jednom mjestu. S obzirom da umjetna inteligencija nije uvijek pouzdana, pogotovo u rješavanju matematičkih zadataka, ako jedan model ne uspije riješiti zadatak, najčešće se među ostalima nađe onaj koji zna.
                Tako učenici dobivaju širi pregled i dublje razumijevanje
                matematike što im pomaže da lakše razumiju gradivo."</p>
            ...
            <div className="item">
              ...
              <p>"Kroz proteklih godinu dana, primijetila sam kako su AI modeli znatno napredovali u testiranju zadataka.
                AI modeli u trenutnom izdanju nude izvrstan, novi princip učenja koji osigurava jasne odgovore na pitanja i objašnjenja gradiva na jednostavan i razumljiv način u svako doba dana i noći.
                Također, koristan je za učenike jer pruža instantne povratne informacije prilagođene potrebama pojedinca."</p>
              <div className="client_info">
            ...
            <div className="item">
              ...
              <p>"Najveću prednost aplikacije vidim u tome što omogućuje korištenje više LLM-ova i modela, pružajući uvid u različite načine rješavanja istog zadatka – nekad detaljno i
                temeljito, nekad sažeto i brzo.
                Posebno mi se sviđa što je sistemski prompt pažljivo osmišljen, a također nudi i opciju 'Prilagodi sebi' kako bi svatko mogao personalizirati rješavanje zadataka prema svojim potrebama."</p>
              <div className="client_info">
            ...
            <div className="item">
              ...
              <p>"Kod edureteAI me iznenadila njegova svestranost i
                prilagodljivost zadacima koji se pred njega stave.
                U sebi sadrži više modela koji omogućuju da se istom problemu pristupi s više gledišta ili postupaka što produbljuje razumijevanje problema.
                Veliku prednost vidim i u opciji da se personalizira pristup i način na koji edureteAI daje odgovore putem ugrađenog prozora dodatnih postavki."</p>
              <div className="client_info">
            ...
            <div className="item">
              ...
              <p>"Prednost edureteAI-a je u tome što pruža više opcija za rješavanje zadataka, prilagođenih različitim stilovima učenja, koristeći različite LLM-ove. Nalazimo se u vremenu kada priprema za maturu postaje optimalnija nego ikada prije, omogućujući učenicima učinkovitije usvajanje gradiva i bolje rezultate
                Uspješno rješava veliku većinu matematičkih i drugih zadataka."</p>
              <div className="client_info">
            ...
            <div className="item">
              ...
              <p>"Najveća prednost aplikacije edureteAI koju sam primijetila je mogućnost pružanja pomoći u rješavanju i objašnjenju teorije jednostavnijih i kompliciranijih matematičkih zadataka u doba dana kada profesionalni stvarni instruktori inače nisu dostupni a potrebno je brzo provjeriti znanje.
                Drugu prednost koja je dosta izražena je mogućnost korištenja više modela pomoću kojih se mogu dobiti različiti postupci rješavanja istog zadatka."</p>
              <div className="client_info">
            ...
            <div className="row justify-content-center d-flex align-items-stretch" style={{marginBottom: '20px'}}>
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="saas_price_item w-100 d-flex flex-column">
                  ...
                  <ul className="list-unstyled flex-grow-1">
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png"/> Besplatno</li>
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png"/> 50 poruka</li>
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png"/> Odabrani snimci za lakše
                      učenje
                    </li>
                  </ul>
                  <Link href="/sign-up" className="price_btn">Isprobaj</Link>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="saas_price_item w-100 d-flex flex-column">
                  ...
                  <ul className="list-unstyled flex-grow-1">
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png"/> 1500 poruka</li>
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png"/> Odabrani snimci za lakše
                      učenje
                    </li>
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png"/><span style={{color: 'red'}}>Posebna promo akcija za prvih 100 učenika</span> - 2 X 30 minuta sa instruktorom</li>
                  </ul>
                  <Link href="/sign-up" className="price_btn">Isprobaj</Link>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 d-flex">
                <div className="saas_price_item w-100 d-flex flex-column">
                  ...
                  <ul className="list-unstyled flex-grow-1">
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png" alt=""/> 1500 poruka</li>
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png" alt=""/> Odabrani snimci za
                      lakše učenje
                    </li>
                    <li><img className="d-inline" src="/assets/img/home-one/check_3.png" alt=""/> 4 X 30 minuta svaki
                      mjesec sa instruktorom
                    </li>
                  </ul>
                  <Link href="/sign-up" className="price_btn">Isprobaj</Link>
                </div>
        ...
        <section className="saas_faq_area sec_padding" id="faq">
          <div className="container">
            <div className="section_title text-center">
              ...
              <p className="wow fadeInUp" data-wow-delay="0.4s">Pronađite odgovore na najčešća pitanja vezana uz
                sustav, kupnju, ažuriranja, podršku te korištenje same stranice i njenog rada</p>
            </div>
                    ...
                    <div id="collapseFe112" className="accordion-collapse collapse"
                      ...
                      <div className="accordion-body">
                        ...
                        <p>Cilj je pružiti najbolje moguće iskustvo učenja matematike kroz pristup različitim AI
                          sustavima. Korisnici mogu odabrati bilo koji od ponuđenih sustava prema svojim
                          preferencijama.
                          Dodatna mogućnost prilagodbe je poseban okvir za dodatne upute, pomoću kojeg se EdureteAI
                          može
