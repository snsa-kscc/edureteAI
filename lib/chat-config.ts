export const CHAT_MODELS = [
  { value: "accounts/fireworks/models/deepseek-r1-0528", label: "Deepseek/DeepSeek R1" },
...
export const MODELS_WITHOUT_IMAGE_SUPPORT = ["o1-preview", "o1-mini", "o3-mini", "accounts/fireworks/models/deepseek-r1-0528", "deepseek-ai/DeepSeek-R1"];

export const DEFAULT_LEFT_MODEL = "gpt-5-mini";
