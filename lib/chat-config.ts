export const CHAT_MODELS = [
  {
    value: "accounts/fireworks/models/deepseek-r1-0528",
  ...
  { value: "claude-sonnet-4-20250514", label: "Anthropic/Claude Sonnet 4" },
  {
    ...
    label: "Anthropic/Claude Sonnet 4 (Thinking)",
  },
];

export const MODELS_WITHOUT_IMAGE_SUPPORT = [
  "o1-preview",
  "o1-mini",
  "o3-mini",
...
export const DEFAULT_LEFT_MODEL = "claude-sonnet-4-thinking";
